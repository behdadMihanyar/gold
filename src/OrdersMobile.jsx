...
const OrdersMobile = () => {
  ...
  const { pagebuy, setPagebuy, totalCountBuy, setTotalCountBuy } =
    useDataContext();
            ...
            {editingIdBuy === order.id ? (
              <>
                <input
                  ...
                  onChange={(e) =>
                    handleEditChange(e, setEditFormDataBuy, editFormDataBuy)
                  }
              ...
              <>
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    onClick={() =>
                      handleEdit(order, setEditingIdBuy, setEditFormDataBuy)
                    }
                  ...
                  <button
                    onClick={() =>
                      handleDelete(order.id, ordersBuy, setOrdersBuy)
                    }
